...
DataFolderPath = "C:\Users\giugi\Dropbox\Building systems group project\DataDrivenAnalysis\Temperature Prediction in a Domotic House--Bortolotti-Martinelli-Spirito"
...
predict_DF_linearReg_split_ChosenDates = predict_DF_linearReg_split["2012-03-20":"2012-03-26"]
...
# # Conclusion
# We can point out that both models turn to be a good approximation of the actual values behaviour. In particular, the linear regression is the model which reaches higher R-Squared showing to be the best fit.
