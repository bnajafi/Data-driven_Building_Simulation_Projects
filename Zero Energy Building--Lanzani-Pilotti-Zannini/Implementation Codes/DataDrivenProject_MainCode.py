...
DF_FinalDataSet=lag_column(DF_FinalDataSet, "indoor temperature", lag_period=8, initial_time=4) # correlazione della temperatura stessa coi valori assunti nelle ore precedenti.
